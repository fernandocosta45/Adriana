    ...
    public PrincipalGUI() {
        ...
        calcularAlimentoBtn.addActionListener(e -> {
            try {
                ...
                resultadoAlimento.setText("Erro: insira valores numéricos válidos.");
            }
        });
        ...
        exibirMedBtn.addActionListener(e -> {
            try {
                ...
                med.exibirInfo();
                resultadoMed.setText("Info exibida no console.");
            } catch (NumberFormatException ex) {
                resultadoMed.setText("Erro: insira valores numéricos válidos.");
            }
        });
        ...
        exibirServBtn.addActionListener(e -> {
            try {
                ...
                servico.exibirInfo();
                resultadoServ.setText("Info exibida no console.");
            } catch (NumberFormatException ex) {
                resultadoServ.setText("Erro: insira valores numéricos válidos.");
            }
        });
